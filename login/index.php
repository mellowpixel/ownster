        ...
        <header>
         ...
         <main >
            <div class="content-wrapper"> 
              ...
              <form id="login-form" name="loginform" ng-submit="submitForm(loginform.$valid)" novalidate>
                <div class="form-row" ng-class="{ 'has-error' : loginform.login.$invalid && submitted }">
                    <label for="name-input" class="control-label">E-mail</label>
                    <input class="form-control" type="email" name="login" ng-model="login" required>
                    <p ng-show="loginform.login.$invalid && submitted" class="help-block">Your login is required.</p>
                </div>
                <div class="form-row" ng-class="{ 'has-error' : (loginform.password.$invalid || loginform.password.$error.minlength) && submitted }">
                    <label class="control-label">Password</label>
                    <input class="form-control" ng-model='password' type="password" name='password' required>
                    <p ng-show="(loginform.password.$invalid || loginform.password.$error.minlength) && submitted" class="help-block">Password is too short.</p>
                </div>
                <div class="form-row">
