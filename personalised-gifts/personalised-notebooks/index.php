...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Create your own personalised notebook with favourite photos – from only £7.99. Free UK Delivery. Add your own photos, designs, logos or text. Unique Personalised Gifts for your relatives, loved ones, friends or colleagues.">
    <meta name="keywords" content="personalised notebook, personalised notebooks, personalized notebook, photo notebook, photo upload notebook">
    ...
    <title>Personalised Notebooks, Photo Gifts – from only £7.99</title>
        ...
        <main>
            <div class='content-wrapper'>
                ...
                <div class='page-title-description-wrapper'>
                    <h2>Personalised Notebooks</h2>
                    <p>Bring lovely memories to someone’s routine.</p>
                </div>
...
/*
                    if(isset($_GET["group"])){
                        ...
                        // SET IDS OF PRODUCTS TO LOAD IN $list variable
                        switch($_GET["group"]){
                            case "travel-card-wallets": $list = "AND id IN(3, 6, 8, 9)"; break;
                            case "notebook": $list = "AND id IN(10, 11, 12, 13, 14, 15)"; break;
                            default : $list = ""; break;
                        }
                        loadProducts($list);
                    } else {
                        ...
                        loadProducts("AND id IN(10, 11, 12, 13, 14, 15)");
                    ?>
                </div>
